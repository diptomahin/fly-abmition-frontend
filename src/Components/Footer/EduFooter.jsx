        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              FlyAmbition is a trusted educational consultancy guiding students
              to achieve their dreams of studying abroad. We partner with top
              universities worldwide, providing end-to-end support from
