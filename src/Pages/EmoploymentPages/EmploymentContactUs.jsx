...
const EmploymentContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 bg-[#4f2e89]">
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="bg-[#4f2e89] text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-700 transition-colors flex items-center justify-center">
