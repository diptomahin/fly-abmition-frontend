...
const ManageStories = () => {
  ...
  const [activeTab, setActiveTab] = useState("Employment"); // Default tab
  ...
  const filteredStories =
    activeTab === "Education"
      ? stories.filter((s) => s.role === "Student")
      : stories.filter((s) => s.role !== "Student");
        ...
        {filteredStories.map((story) => (
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-300 mb-2">
              {story.type} — {story.role} ({story.country})
            </p>
